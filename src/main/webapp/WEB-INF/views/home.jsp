...
<body>
  ...
  <div id="content"> 
    ...
    <section class="hero-wrap section shadow-md py-4">
      ...
      <div class="hero-bg" style="background-image:url('${pageContext.request.contextPath}/resources/images/bg/image-1.jpg');"></div>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-xl-5 my-auto">
              <div class="bg-white rounded shadow-md p-4">
                <h3 class="text-5 text-center"><c:if test="${empty userVO }">비회원 </c:if>예약하기</h3>
                <hr class="mb-4">
				  ...
				  <p class="mt-3 mb-0" onclick="goGuest()"><a href="#close-account" data-toggle="modal" class="text-muted btn-link">비회원 예약조회<span class="text-1 ml-1"><i class="fas fa-chevron-right"></i></span></a></p>
				  </c:if>
              </div>
            </div>
          </div>
    ...
    <section class="hero-wrap py-5">
      ...
      <div class="hero-content">
        <div class="container d-md-flex text-center text-md-left align-items-center justify-content-center">
          <h2 class="text-6 font-weight-600 text-white mb-3 mb-md-0">가입하면 주요통화 100% 우대 쿠폰 지급!<span style="font-weight: 300;">(~10/31까지)</span></h2>
          <a href="${pageContext.request.contextPath}/signup" class="btn btn-outline-light text-nowrap ml-4">회원가입</a> </div>
      </div>
    </section>
    </c:if>
    <section class="hero-wrap py-5">
      <div class="hero-mask opacity-5 bg-dark"></div>
      <div class="hero-bg" style="background-image:url('${pageContext.request.contextPath}/resources/images/assets/inbyu_01.png');"></div>
      <div class="hero-content">
        <div class="container d-md-flex text-center text-md-left align-items-center justify-content-center">
          <h2 class="text-6 font-weight-600 text-white mb-3 mb-md-0"><span style="font-weight: 300;">잠깐! </span>해외여행보험은 준비하셨나요?</h2>
          <a href="https://extend.inbyu.com/?auth=EC3D48EF7FAED9DBD5EB460B95208A45" target="_blank" class="btn btn-outline-light text-nowrap ml-4">해외여행보험 가입하기</a> </div>
      </div>
    </section>
    <!-- Special Offer end --> 
  ...
  <div id="exit-modal" class="modal fade " role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header" style="text-align: center; display: inline;">
                  <h6 class="modal-title font-weight-400">웨이즈 서비스 종료 안내</h6>
                </div>
                <div class="modal-body p-4">
                    <div class="row">
                      <div class="col-12" style="margin-bottom: 30px;">
                        안녕하세요. 웨이즈 입니다.<br>
						아쉽게도 웨이즈가 2019년 11월 8일을 마지막으로 서비스를 종료하게 되었습니다.<br>
						지난 시간 웨이즈를 애용해주시고 성원을 보내주셔서 진심으로 감사드립니다. 더불어 저희 서비스를 사랑해주신 회원님께 깊은 사과의 말씀을 드립니다.<br>
						2019년 11월 8일을 마지막으로 웨이즈 서비스(앱/웹)가 종료됨을 알려드립니다. 관련한 후속 조치는 하단의 내용을 참고하시길 바랍니다.<br><br>
						[후속 조치 일정]<br>
						– 회원가입 정지 : 2019년 11월 1일(금) 11:00 (인증번호 미전송 방식)<br>
						– 예약서비스 정지 : 2019년 11월 1일(금) 11:00<br>
						– 외화수령서비스 정지: 기존 접수된 예약은 정상 수령 가능<br>
						– 취소/환불: 2019년 11월 8일(금)까지 취소/환불건 2019년 11월 11일(월) 처리<br>
						– 고객센터 운영: 2019년 11월 11일(월) 18:00까지 정상 운영(채팅, 전화)<br>
						– 개인정보파기: 개인정보보호법 및 당사 개인정보처리방침에 근거하여 적법한 절차에 따라 보관 및 파기 절차를 진행할 예정입니다.<br>
						* 이후 변동사항 추후 공지<br>
						* 후속 조치 일정을 확인하시어 고객 여러분의 소중한 여행 계획에 참고하시길 바랍니다.<br>
						* 기존 접수된 예약에 대해서는 문제없이 외화 수령 서비스가 진행되오니 안심하시고 이용하셔도 됩니다.<br>
						다시 한 번 진심으로 감사합니다.<br>
						웨이즈 팀 드림
                      </div>
                    </div>
  ...
  <a href="#exit-modal" id="md_trig" data-toggle="modal" style="display:none;"></a>
	<!-- 금액 비교하기 -->
...
<form name="formBody" action="${pageContext.request.contextPath}/rsv" method="post">
...
<div class="dialog_back" style="display:none;"></div>
<div class="dialog" style="display:none;" id="dialog_down">
	<div class="dialog_body">
		<div class="dialog_title">
			<img style="width: 40%;" src="${pageContext.request.contextPath}/resources/images/appicon.png">
		</div>
		
		<div class="dialog_button">
			<div class="dia_btn" onclick="goDownPage()">웨이즈 앱으로 보기</div>
		</div>
		<div class="dia_under" onclick="closeDialog()">괜찮습니다. 모바일웹으로 볼게요.</div>
	</div>
</div>
...
//     if (uagentLow.search("android") > -1 || uagentLow.search("iphone") > -1) { // 안드로이드 or 아이폰

//     		$('.dialog_back').css('display', 'block');
//         	$('#dialog_down').css('display', 'block');
        	
//         	$('#dialog_down').scrollLock('enable');
//     } 
...
function rsvDetail(){
	...
	FORM_BODY.attr('action', '${pageContext.request.contextPath}/rsv');
	FORM_BODY.submit();
}

function goGuest(){
	location.href = '${pageContext.request.contextPath}/guest';
}
...
function closeDialog(){
	$('#dialog_down').scrollLock('disable');
	$('.dialog_back').css('display', 'none');
	$('#dialog_down').css('display', 'none');
}
